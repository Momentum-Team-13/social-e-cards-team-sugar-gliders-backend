...
class GreetingCard(TimeStamp):
	...
	card_color = models.CharField(null=True, max_length=100)
	...
	card_image = models.TextField(max_length=255, null=True, blank=True)
	card_image_file = models.ImageField(upload_to='card_images', null=True, blank=True, max_length=255)
